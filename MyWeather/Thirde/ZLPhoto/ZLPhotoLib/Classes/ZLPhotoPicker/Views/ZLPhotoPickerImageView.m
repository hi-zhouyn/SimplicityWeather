...
- (void)setAnimationRightTick:(BOOL)animationRightTick{
    ...
    if (animationRightTick) {
        self.tickImageView.layer.borderWidth = 6 * kAUTOLAYOUTSCALE;
        self.tickImageView.layer.borderColor = kColorOrangeRed.CGColor;
//        [self.tickImageView setImage:[UIImage ml_imageFromBundleNamed:@"icon_image_yes"] forState:UIControlStateNormal];
    }else{
        [UIView animateWithDuration:0.2 animations:^{
            self.tickImageView.layer.borderWidth = 0;
            self.tickImageView.layer.borderColor = [UIColor clearColor].CGColor;
        }];
//        [self.tickImageView setImage:[UIImage ml_imageFromBundleNamed:@"icon_image_no"] forState:UIControlStateNormal];
    ...
    scaoleAnimation.duration = 0;
    scaoleAnimation.autoreverses = YES;
    scaoleAnimation.values = @[[NSNumber numberWithFloat:1.0],[NSNumber numberWithFloat:1.0],[NSNumber numberWithFloat:1.0]];
