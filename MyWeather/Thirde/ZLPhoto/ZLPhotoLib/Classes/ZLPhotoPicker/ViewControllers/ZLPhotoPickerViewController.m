...
- (void) createNavigationController{
    ...
    // 设置标题字号及颜色
    [nav.navigationBar setTitleTextAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17 * kAUTOLAYOUTSCALE],NSForegroundColorAttributeName:kColorBlack}];
    nav.navigationItem.rightBarButtonItem.tintColor = kColorOrangeRed;
    nav.navigationItem.leftBarButtonItem.tintColor = kColorOrangeRed;
    nav.navigationBar.tintColor = kColorOrangeRed;
